...
module Gql.DockerAPI.Object.Driver exposing (..)
...
{-| -}
name : SelectionSet (Maybe String) Gql.DockerAPI.Object.Driver
name =
    Object.selectionForField "(Maybe String)" "name" [] (Decode.string |> Decode.nullable)


{-| -}
options : SelectionSet (Maybe Gql.DockerAPI.ScalarCodecs.StringAnyMap) Gql.DockerAPI.Object.Driver
options =
